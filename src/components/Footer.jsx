  ...
  return (
    <footer className={`w-full py-20 font-['Inter',_sans-serif] ${darkMode ? "bg-black text-white" : "bg-white text-zinc-800"}`}>
      <div className="max-w-5xl mx-auto md:px-20">
        {/* Quote Section */}
        <div className={`relative p-8 md:p-12 rounded-3xl border mb-16 transition-colors ${darkMode
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <p className={`cl text-xl md:text-2xl font-medium italic ${darkMode ? "text-zinc-300" : "text-zinc-600"}`}>
        ...
        <div className="flex justify-center mb-16">
          <div className={`flex items-center gap-3 px-4 py-2 rounded-2xl border transition-colors ${darkMode
        ...
        <div className="text-center space-y-2">
          <p className={` title text-[15px] font-medium ${darkMode ? "text-zinc-500" : "text-zinc-400"}`}>
            Design & Developed by <span className={darkMode ? "text-white" : "text-zinc-900"}>Biswajit Das❤️</span>
          </p>
          <p className={`title text-[13px] ${darkMode ? "text-zinc-600" : "text-zinc-400"}`}>
